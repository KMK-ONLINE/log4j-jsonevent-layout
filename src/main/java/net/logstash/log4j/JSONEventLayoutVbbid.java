...
public class JSONEventLayoutVbbid extends Layout {
     ...
     *                     messages.
     */
    public JSONEventLayoutVbbid(boolean locationInfo) {
    ...
    public String format(LoggingEvent loggingEvent) {
        ...
        String strTimestamp = dateFormat(timestamp);
        logstashEvent.put("@timestamp", strTimestamp);
        logstashEvent.put("syslog_timestamp", strTimestamp);
        ...
        addEventData("severity", loggingEvent.getLevel().toString());
